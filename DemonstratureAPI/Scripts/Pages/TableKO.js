define(["require", "exports", "../helpers/DemonstratureCustomClasses"], function (require, exports, DemonstratureCustomClasses_1) {
    "use strict";
    ...
    class TableVM {
        ...
        constructor() {
            ...
            this.test = () => {
                var self = this;
                console.log("testing" + ".");
                var x = DemonstratureCustomClasses_1.KoTestClass;
                console.log(x);
                //$.notify("helloworld");
                //self.notify("test", 0);
                //var a = KoTestClass;
